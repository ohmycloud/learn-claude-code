"""
s01-agent-loop.py - The Agent Loop
...
SYSTEM = "You are a coding agent at {os.getcwd()}. Use bash to solve tasks. Act, don't explain."
...
def run_bash(command: str) -> str:
    dangerous = ["rm -rf /", "sudo", "shutdown", "reboot", "> /dev/null"]
